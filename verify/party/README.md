...
|---|---|
| `risk-bearer` | an entry in `platform/risk/appetite.json`, fetched by [`../../clone-estate.sh`](../../clone-estate.sh) into `../../.estate-clone/platform/risk/appetite.json` (platform is a real, separate GitHub repo post-split; there is no longer an in-tree sibling to link to directly) |
