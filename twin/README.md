...
**17 of 48**, and every artefact carries an overall depth of `partial`, which is the *worst* of the
...
count — most rows below track only as far as build ticket 33 tells their story; `scenario-engine`
moved to 2/7 at build ticket 37 (AC 2, fast-forward/rewind/play distinguished) and `sense-move`
moved to 4/8 across build tickets 43 and 44, neither move narrated in its own round below.
