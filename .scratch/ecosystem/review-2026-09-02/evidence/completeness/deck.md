...
theme: default
paginate: true
footer: "generated by talk/build_deck.py · run=local · hub=5b1a891 · 2026-08-31T17:04Z"
style: |
...
built 2026-08-31T17:04Z during run **local** (a local run, not the scheduled one) · hub `5b1a891`. Each beat quotes the capture on disk for its own check, and carries the grade that capture gave.
