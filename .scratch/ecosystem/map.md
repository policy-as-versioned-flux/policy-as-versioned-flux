...
- The prediction-market feed (reversal 6) and the news/headline feed with its headline-to-coordinate skill (GAPS 1.12): both are feeds under the contract; specifics wait on it.
