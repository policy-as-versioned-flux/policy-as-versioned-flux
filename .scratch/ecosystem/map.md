...
- Placement of the scanner, notification spine and OSCAL CronJob after ticket 35 decides lift-or-retire for them. The currency controller is **not** among them: its retirement was withdrawn (ticket 75 Q13) and executed as an un-retirement by ticket 91 on 2026-09-05 — it is owned by platform, numbered by the platform's tag, and its sentence is graded.
